...
public class DT2WServiceDuchamp extends Service {
    private static final String TAG = "DT2WServiceDuchamp";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.duchamp.dt2w", dt2wEnabled ? "1" : "0");
        }
